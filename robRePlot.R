...
## args <- c("~/Seattle/Robust/RRout", "~/Seattle/stGraph.rds")
...
abline(v=smthmin, lty=2)
legend("topleft", legend=c("Resample 40% of cases", "Resample 60% of cases", "Resample 80% of cases"), fill=c("red", "orange", "yellow"), title = "Resamples Groups (N=10)")
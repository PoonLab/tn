sGs <- readRDS("Data/ThesisData/sTs_Rand.rds")
nGs <- readRDS("Data/ThesisData/nTs_Rand.rds")
tGs <- readRDS("Data/ThesisData/tTs_Rand.rds")
tGs_Comp <- readRDS("Data/ThesisData/tTs_Comp_Rand.rds")
tGs_Diag <- readRDS("Data/ThesisData/tTs_Diag_Rand.rds")
...
pdf(file="~/gaicPlots-Rand.pdf", width=14, height=7)
par(mfrow=c(1,2),mar=c(5,6,4,1)+.1)

#PlotA
plot(x=0, y=0, type='n', xlab="Patristic distance threshold", ylab="AIC Difference (Random - Null)", xlim=c(0,0.15), ylim=c(-50, 50),
...
abline(h=seq(40, -40, -20), col='white', lwd=3, lend=2)
abline(h=seq(30, -30, -20), col='white', lend=3)
